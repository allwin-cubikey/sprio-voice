...
export function AdminAnalyticsPage() {
    ...
    const data = React.useMemo(() => {
        ...
        return {
            stats, revenueData, dailyTrend, userGrowth, planRevenue, topOrgs,
            callOutcomes, hourlyDist, directionData, sentimentData, geoData, assistantPerf
        };
    }, []);

    const slicedTrend = preset === '7d' ? data.dailyTrend.slice(-7) : preset === '30d' ? data.dailyTrend.slice(-30) : data.dailyTrend;
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-3">
                <KpiCard title="Total Users" value={data.stats.totalUsers} icon={Users} color="#6366f1" trend="+18%" trendUp sub={`${data.stats.activeUsers} active`} />
                <KpiCard title="Platform MRR" value={`$${data.stats.totalMRR.toLocaleString()}`} icon={DollarSign} color="#22c55e" trend="+12%" trendUp sub={`ARR $${(data.stats.totalMRR * 12).toLocaleString()}`} />
                <KpiCard title="Total Calls" value={data.stats.totalCalls.toLocaleString()} icon={PhoneCall} color="#f59e0b" trend="+24%" trendUp sub="All time" />
                <KpiCard title="Assistants" value={data.stats.totalAssistants} icon={Bot} color="#8b5cf6" trend="+9" trendUp sub="Across all orgs" />
                <KpiCard title="Avg Call Duration" value={`${data.stats.avgCallDuration}s`} icon={Clock} color="#10b981" sub="Per completed call" />
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
                    <div className="card p-4">
                        ...
                        <ResponsiveContainer width="100%" height={200}>
                            <BarChart data={data.revenueData} margin={{ left: -20 }}>
                                <CartesianGrid strokeDasharray="3 3" stroke="#222" />
                    ...
                    <div className="card p-4">
                        ...
                        <ResponsiveContainer width="100%" height={200}>
                            <AreaChart data={data.userGrowth} margin={{ left: -20 }}>
                                <defs>
                ...
                <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
                    ...
                    <div className="card p-4">
                        ...
                        <ResponsiveContainer width="100%" height={180}>
                            <PieChart>
                                <Pie data={data.planRevenue} cx="50%" cy="50%" innerRadius={45} outerRadius={72} dataKey="users" strokeWidth={0} paddingAngle={2}>
                                    {data.planRevenue.map((p, i) => <Cell key={i} fill={p.color} />)}
                                </Pie>
                    ...
                    <div className="card p-4 xl:col-span-2">
                        ...
                        <ResponsiveContainer width="100%" height={220}>
                            <BarChart data={data.topOrgs} layout="vertical" margin={{ left: 100 }}>
                ...
                <div className="grid grid-cols-1 xl:grid-cols-4 gap-4">
                    ...
                    <div className="card p-4">
                        ...
                        <ResponsiveContainer width="100%" height={160}>
                            <PieChart>
                                <Pie data={data.callOutcomes} cx="50%" cy="50%" innerRadius={40} outerRadius={65} dataKey="value" strokeWidth={0}>
                                    {data.callOutcomes.map((c, i) => <Cell key={i} fill={c.color} />)}
                                </Pie>
                    ...
                    <div className="card p-4 xl:col-span-2">
                        ...
                        <ResponsiveContainer width="100%" height={200}>
                            <BarChart data={data.hourlyDist} margin={{ left: -20 }}>
            ...
            <div>
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
                    <div className="card p-4">
                        ...
                        <ResponsiveContainer width="100%" height={200}>
                            <BarChart data={data.geoData} margin={{ left: -20 }}>
                                <CartesianGrid strokeDasharray="3 3" stroke="#222" vertical={false} />
            ...
            <div>
                ...
                <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
                    <div className="card p-4">
                        ...
                        <ResponsiveContainer width="100%" height={200}>
                            <PieChart>
                                <Pie data={data.sentimentData} cx="50%" cy="50%" innerRadius={50} outerRadius={80} dataKey="pct" strokeWidth={0} paddingAngle={2}>
                                    {data.sentimentData.map((s, i) => <Cell key={i} fill={s.color} />)}
                                </Pie>
                                <Tooltip contentStyle={{ background: '#ffffff', border: '1px solid #e5e7eb', borderRadius: 8, fontSize: 11, color: '#111' }}
